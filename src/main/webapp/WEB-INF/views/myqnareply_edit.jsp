...
<%@ include file="../../resources/include/header.jsp" %>
	...
	<c:set var="dto" value="${replyEdit}"></c:set>
	<c:if test="${!empty dto }">
	<div class="content_wrap">
		<div class="is-frame-md">
		    <div class="section table-wrap">
			 <table border="1">  
				<caption>답변수정 페이지</caption>
	<form method="post" action="<%=request.getContextPath() %>/reply_edit_ok.do">
		<tr>
			<th>번호</th>
			<td><input name="reply_no" value="${dto.getMyqna_reanswer()}" readonly></td>
		</tr>		

		<tr>	
			<th>내용</th>
			<td>
				<textarea rows="8" cols="80" name="reply_cont">${dto.getReply_cont()}</textarea>
			</td>
		</tr>			
		<tr>
