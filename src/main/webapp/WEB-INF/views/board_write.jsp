	 ...
	 <div class="container">
                <div class="content">
                   <div class="join_area cotent_width">
					...
					<h3 class="login_title">게시글 작성</h3>
                   ...
                   <c:if test="${!empty cont }">
					...
					<c:if test="${!empty reply }">
						...
						<input type="hidden" value="${dto.getB_head() }" name="b_head">
				   ...
				   <tr>
						<th> 말머리 </th>
					  <td>
						 <select id="headType" name="b_head">
						        <option value="자유게시판">자유게시판</option>
						        <option value="맛집공유">맛집공유</option>
						        <option value="부동산추천">부동산 추천</option>
						    </select>
					  </td>
				   </tr>
				   </c:if>
