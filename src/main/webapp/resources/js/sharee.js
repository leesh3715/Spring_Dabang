...
function edit_comment(c_no,s_no,c_id,c_cont,c_date,c_group,c_step,c_indent){
	...
	/*if($("#check").val()==0){
		...
		html +="┗<a id='reply_on"+c_no+"' onClick='reply_comment("+c_no+","+s_no+",\""+c_id+"\",\""+c_cont+"\","+c_group+")'>답글</a>";
		html +="</td></tr></tbody></table></div>";
		html +="<div class='col-xs-8 col-sm-3' align='right'>";
			...
			if(data.length > 0) { 
				$(data).each(function(){
					...
					if(this.c_indent<1){
						...
						html +="</td><td>";
						html +="<span><font size='1em'>"+this.c_date.substring(0,16)+"</font></span>";
						html +="┗<a id='reply_on"+this.c_no+"' onClick='reply_comment("+this.c_no+","+this.s_no+",\""+this.c_id+"\",\""+this.c_cont+"\","+this.c_group+")'>답글</a>";
						html +="</td></tr></tbody></table></div>";
						html +="<div class='col-xs-8 col-sm-3' align='right'>";
						html +="<table border='0'><tbody><tr><td>";
						html +="<a onClick='edit_comment("+this.c_no+","+this.s_no+",\""+this.c_id+"\",\""+this.c_cont+"\",\""+this.c_date.substring(0,16)+"\","+this.c_group+","+this.c_step+")' style='font-weight: lighter;'>수정</a>";
						html +="<span>&nbsp;|&nbsp;</span>";
						html +="<a onClick='del_comment("+this.c_no+")' style='font-weight: lighter;'>삭제</a>";
						html +="</td></tr></tbody></table></div></div></td></tr>";
						html +="<tr><td><p><span id='c_cont2'>"+this.c_cont+"</span></p></td></tr>";
					}
					else{
						html +="<tr><td><p><span>삭제된 댓글입니다.</span></p></td></tr>";
					}
					html +="</table></div><div style='border-top:1px dashed; margin-top: 2px;'></div>";
					html +="</li><input type='text' id='reply"+this.c_no+"'>";
