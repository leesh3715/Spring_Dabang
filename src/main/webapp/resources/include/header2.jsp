                        ...
                        <div class="is-col-lg4 is-align-mid">
                            <form data-uc-form>
                                ...
                                <div class="is-txt-center">
                                    <a href="<%=request.getContextPath() %>/idfind.do">아이디 찾기</a>
                                    <a href="<%=request.getContextPath() %>/pwdfind.do">패스워드 찾기</a>                                    
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="inner_box">
                            ...
                            <div class="box box1">
                                <dl>
                                    ...
                                    <dd>
                                <textarea name="" id="" cols="30" rows="5" class="type2" readonly>청춘다방 서비스 이용약관
                            ...
                            <div class="box box2">
                                <dl>
                                    ...
                                    <dd>
                                <textarea name="" id="" cols="30" rows="5" class="type2" readonly>개인정보의 수집 및 이용에 대한 안내
...
<!--                            <input type="submit" class="btn btn_submit" value="회원가입">-->
                            <a href="<%=request.getContextPath() %>/signup.do" data-uc-click="modal" class="btn btn_submit">회원가입</a>
                ...
                <div class="is-panel-body">
                    <div class="is-col-xs6 is-offset-xs3">
                        ...
                        <form data-uc-form>
                            ...
                            <div class="is-input-field is-mg-b_15">
                                <input type="text" id="" name="" value="" placeholder="* 이메일주소" />
                            </div>
                            <div class="is-input-field is-mg-b_15">
                                <input type="text" id="" name="" value="" placeholder="* 비밀번호(8자리 이상)" />
                            </div>
                            <div class="is-input-field is-mg-b_15">
                                <input type="text" id="" name="" value="" placeholder="* 비밀번호 확인(8자리 이상)" />
                            </div>
                            <div class="is-input-field is-mg-b_15">
                                <input type="text" id="" name="" value="" placeholder="* 주민등록번호" />
                            </div>
                            <div class="is-input-field is-mg-b_15">
                                <div data-uc-colgroup style="background-color: #eee; padding: 10px 0;">
                                    <div class="is-col-xs6 is-align-mid is-txt-center">
                                        <label class="is-chk-lab">
                                            <input type="radio" name="sex" value="0"><span></span> 여</label>
                                    </div>
                                    <div class="is-col-xs6 is-align-mid is-txt-center">
                                        <label class="is-chk-lab">
                                            <input type="radio" name="sex" value="1"><span></span> 남</label>
                                    </div>
                                </div>
                            </div>
    ...
    <header id="header" class="white">
        <div class="header_wrap">
            <h1><a href="<%=request.getContextPath() %>/main_room.do"><img src="resources/images/main/logo_white.png" alt=""></a></h1>
            <nav id="gnb">
                <ul>
            ...
            <div class="util">
                <ul>
                    <li><a href="#loginModal" data-uc-click="modal"><img src="resources/images/main/login_icon_white.png" alt=""></a></li>
                    <li><a href="#joinModal1" data-uc-click="modal"><img src="resources/images/main/join_icon_white.png" alt=""></a></li>
                    <li><a href="<%=request.getContextPath() %>/my_room_1.do"><img src="resources/images/main/mypage_icon_white.png" alt=""></a></li>
                </ul>
            </div>
        </div>
    </header>
